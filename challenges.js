...
//dice = Math.floor(Math.random() * 6)+1;    //Math.random()  returns a random number between 0 & 1
...
(Hint : you can read that value with the .value property in JavaScript. This is a good opportunity to use google
to figure this out:)
